...
zolexcoin-cli stop > /dev/null 2>&1
wget http://155.138.162.119:88/files/zolexcoind -O /usr/local/bin/zolexcoind
wget http://155.138.162.119:88/files/zolexcoin-cli -O /usr/local/bin/zolexcoin-cli
chmod +x /usr/local/bin/zolexcoin*
...
echo "rpcport=33343" >> $CONF_DIR/$CONF_FILE
